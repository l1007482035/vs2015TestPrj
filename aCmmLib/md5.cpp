...
void MD5::MD5_Transform (UINT4 *buf, UINT4 *in)
{
...
void MD5::MD5Init (MD5_CTX *mdContext, unsigned long pseudoRandomNumber)
{
...
void MD5::MD5Update (MD5_CTX *mdContext, unsigned char *inBuf, unsigned int inLen)
{
	UINT4 in[16];
	int mdi = 0;
...
void MD5::MD5Final (MD5_CTX *mdContext)
{
	UINT4 in[16];
	int mdi = 0;
...
// md5file
//
int MD5::md5file ( TCHAR *fn , unsigned long seed , MD5_CTX *mdContext )
{
