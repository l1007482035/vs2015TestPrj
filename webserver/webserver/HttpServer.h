...
#define W_HTTP_ROOT "."
#define W_HTTP_PATH_DEFAULT        "index.html"
#define W_HTTP_DYNAMICPAGE_DIR     "cgi-bin"
#define W_HTTP_CGIBIN_LINUX        "./cgi-bin/webcgi"
...
private:
	...
	int  m_nPathFileSize;
	std::unordered_map<string, string> m_mapHeader;
