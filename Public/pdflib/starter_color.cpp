/* $Id: starter_color.cpp,v 1.8.2.2 2016/12/15 12:03:08 stm Exp $
 * Starter color:
...
main(void)
{
    try {
        ...
        PDFlib p;
        int font, spot, icchandle, sh, shp, devicen, pattern;
        ...
        if (p.begin_document(outfile, L"errorpolicy=exception") == -1) {
