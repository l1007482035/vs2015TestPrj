  ...
  */
  ...
  switch (client->operation)
  {
	...
	*/
	...
	{
		char *pFileld = httpGetField(client->http, HTTP_FIELD_CONTENT_TYPE);
		WriteFileLog("process http,11,pFileld=%s", pFileld);
  ...
  else
  {
	...
	*/
        ...
        else
	{
	  ...
	  * Handle HTTP Expect...
	  */
			WriteFileLog("=======process ipp,3");
	  if (httpGetExpect(client->http))
	  {
		  WriteFileLog("=======process ipp,4");
	    if (httpGetExpect(client->http) == HTTP_STATUS_CONTINUE)
	    {
			WriteFileLog("=======process ipp,5");
	     /*
	      * Send 100-continue header...
	      */

	     //if (!respond_http(client, HTTP_STATUS_CONTINUE, NULL, NULL, 0))//lzj
    ...
    size_t        length)		/* I - Length of response */
{
  ...
  if (code == HTTP_STATUS_CONTINUE)
  {
    ...
    */
	  WriteFileLog("======respond_http,HTTP_STATUS_CONTINUE");
  ...
  */
  ...
  {
	WriteFileLog("============respond_http,HTTP_STATUS_SWITCHING_PROTOCOLS");
