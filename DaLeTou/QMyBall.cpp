		...
		if (!m_bBallForbid)//可用界面
		{
			if (!m_bBallSelected)//未选中->选中
			{
				...
				if (qsObjName == "pushButton_blue1" || qsObjName == "pushButton_blue2" || qsObjName == "pushButton_blue3" || qsObjName == "pushButton_blue4"
					...
					|| qsObjName == "pushButton_blue1_2" || qsObjName == "pushButton_blue2_2" || qsObjName == "pushButton_blue3_2" || qsObjName == "pushButton_blue4_2"
					|| qsObjName == "pushButton_blue5_2" || qsObjName == "pushButton_blue6_2" || qsObjName == "pushButton_blue7_2" || qsObjName == "pushButton_blue8_2"
					|| qsObjName == "pushButton_blue9_2" || qsObjName == "pushButton_blue10_2" || qsObjName == "pushButton_blue11_2" || qsObjName == "pushButton_blue12_2"
					|| qsObjName == "pushButton_blue13_2" || qsObjName == "pushButton_blue14_2" || qsObjName == "pushButton_blue15_2" || qsObjName == "pushButton_blue16_2"
					)
				{
