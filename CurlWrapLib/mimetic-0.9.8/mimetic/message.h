...
/// text/html entity class, add by zxl
struct TextHtml: public TextEntity
{
    TextHtml(const std::string& text);
    /**
     * constructs a TextHtml object, assigns <i>text</i> to its body and adds
     * a ContentType::Param("charset", <i>charset</i>) to ContentType parameter list
     */
    TextHtml(const std::string& text, const std::string& charset);
    /**
     * constructs a TextHtml object, assigns <i>text</i> to its body and adds
     * a ContentType::Param("charset", <i>charset</i>) to ContentType parameter list
	 * and a ContentTransferEncoding to Header parameter list
     */
	TextHtml(const std::string& text, const std::string& charset, const std::string& ContentTransferEncoding);
};
