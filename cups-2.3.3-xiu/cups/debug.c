                   ...
                   ...)			/* I - Additional arguments as needed */
{
  ...
  */
// printf("====debug_init=%x,_cups_debug_fd=%d,format=%s\n", debug_init, _cups_debug_fd, format);
  if (!debug_init)
    //_cups_debug_set(getenv("CUPS_DEBUG_LOG"), getenv("CUPS_DEBUG_LEVEL"),getenv("CUPS_DEBUG_FILTER"), 0);
	  _cups_debug_set("CUPS_DEBUG_LOG.log", "CUPS_DEBUG_LEVEL", NULL, 0);
 ...
 // printf("===========debug_init=%d\n", debug_init);
  ...
  if (!debug_init || force)
  {
    ...
    */
    ...
    debug_init = 1;
	//printf("============debug_init=%d,_cups_debug_fd=%d\n", debug_init, _cups_debug_fd);
  }
