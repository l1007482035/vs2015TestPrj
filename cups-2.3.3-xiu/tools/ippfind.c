  ...
  */
       ...
       search = (const char *)cupsArrayNext(searches))
  {
	...
	*domain++ = '\0';
	...
	printf("ippfind,5,*domain=%x,name=%x\n", *domain, name);
    ...
    else
    {
      ...
      */
      ...
      ref = dnssd_ref;
	  printf("ippfind,6.1,regtype=%s,domain=%s\n", regtype, domain);
