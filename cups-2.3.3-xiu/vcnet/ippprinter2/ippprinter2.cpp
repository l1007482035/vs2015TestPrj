	...
	int            sock)	/* I - Listen socket */
{
	...
	if ((client = (ippeve_client_t	*)calloc(1, sizeof(ippeve_client_t))) == NULL)
	{
...
create_job(ippeve_client_t *client)	/* I - Client */
{
	...
	*/
	...
	if ((job = (ippeve_job_t*)calloc(1, sizeof(ippeve_job_t))) == NULL)
	{
	...
	ipp_t        *attrs)		/* I - Capability attributes */
{
	...
	*/
	...
	if ((printer = (ippeve_printer_t*)calloc(1, sizeof(ippeve_printer_t))) == NULL)
	{
...
#  endif /* HAVE_SSL */
	...
	*/
	...
	printf("===========DNSServiceRegister,3,regtype=%s\n", regtype);
...
#  ifdef HAVE_SSL
	...
	*/
	...
	printf("===========DNSServiceRegister,4,regtype=%s\n", regtype);
#if 0 //lzj
