...
then
  C:/Program Files (x86)/Microsoft Visual Studio 9.0/Common7/IDE/devenv.com $targets_to_make ${EIGEN_MAKE_ARGS}
else
  C:/Program Files (x86)/Microsoft Visual Studio 9.0/Common7/IDE/devenv.com $targets_to_make 
fi
exit $?
