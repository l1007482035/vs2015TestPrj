...
//extern TCPSocket *mDNSPlatformTCPSocket(TCPSocketFlags flags, mDNSIPPort *port, mDNSBool useBackgroundTrafficClass); //lzj creates a TCP socket
...
//extern UDPSocket *mDNSPlatformUDPSocket(const mDNSIPPort requestedport);//lzj
